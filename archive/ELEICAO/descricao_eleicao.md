...
Extração: Ingestão automática de dados brutos (local de votacao, perfil, e urnas) dados disponibilizados pelo TSE.
...
Transformação (dbt): Criação das tabelas ultilizadas com filtros de Anos e Estados 
